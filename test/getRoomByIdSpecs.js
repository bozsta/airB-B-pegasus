...
describe('Get room by id', () => {
    ...
    describe('Should success', () => {
        it('get all rooms data', done => {
            chai.request(app)
            .get(`/room/222222222222222222222222`)
            .end((req,res) => {
                res.should.have.status(200)
                expect(res.body._id).to.equal('222222222222222222222222')
                expect(res.body.user.account.username).to.equal('username')
                done()
            })
        })
    })
    describe('Should failled', () => {
        it('wrong id', done => {
            chai.request(app)
            .get(`/room/444444444444444444444444`)
            .end((req,res) => {
                res.should.have.status(200)
